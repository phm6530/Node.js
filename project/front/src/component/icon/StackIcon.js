...
const Html = ({label}) =>{
    const ctx = useContext(DarkMode);  
    return( <IconStyle $stack={'html'} $darkMode={ctx.darkMode}> <img src="/img/stackIcon/html.png" alt={label} />{label}</IconStyle>)
}

const Css = ({label}) =>{
    const ctx = useContext(DarkMode);  
    return( <IconStyle $stack={'css'} $darkMode={ctx.darkMode}> <img src="/img/stackIcon/css.png" alt={label} />{label}</IconStyle>)
}

const Js = ({label}) =>{
    const ctx = useContext(DarkMode); 
    return( <IconStyle $stack={'js'} $darkMode={ctx.darkMode}> <img src="/img/stackIcon/js.png" alt={label} /> {label}</IconStyle>)
}
const React = ({label}) =>{
    const ctx = useContext(DarkMode); 
